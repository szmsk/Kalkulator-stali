...
export const STANDARD_ANGLE_BARS: Record<string, number> = {
  // Kątowniki równoramienne (Equal angle bars): H x H x T
  '20x20x3': 0.88,
  '20x20x4': 1.14,
  '25x25x3': 1.12,
  '25x25x4': 1.45,
  ...
  // Kątowniki nierównoramienne (Unequal angle bars): H1 x H2 x T (H1 >= H2)
  '30x20x3': 1.11,
  '30x20x4': 1.45,
  '40x20x3': 1.35,
  '40x20x4': 1.77,
